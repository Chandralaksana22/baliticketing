...
{#if isMobile}
	<div class="block lg:hidden fixed w-100 bottom-0 left-0 right-0 z-[99]">
		<div class="nav-bottom-bar flex justify-center items-center justify-between py-5 px-10">
			<a data-sveltekit-preload-code="eager" href="/" class="flex flex-col items-center" class:active-mobile={$page.url.pathname === `/`}
				><svg
			...
			><a data-sveltekit-preload-code="eager" href="/placetogo" class="flex flex-col items-center" class:active-mobile={$page.url.pathname.includes('/placetogo') || $page.url.pathname.includes('/vendormobile')}
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			><a data-sveltekit-preload-code="eager" href="/ticket" class="flex flex-col items-center" class:active-mobile={$page.url.pathname === `/ticket`}
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			><a data-sveltekit-preload-code="eager" href="/contact" class="flex flex-col items-center" class:active-mobile={$page.url.pathname === `/contact`}
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
					...
					></path></svg
				>
				<p class="text-white text-center text-xs">Contact Us</p></a
			>
		</div>
	</div>
{:else}
	...
	>
		<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
			<a data-sveltekit-preload-code="eager" class="flex items-center space-x-3 rtl:space-x-reverse" href="/">
