	...
	<footer class="bg-cover bg-[url('/images/bgfooter.png')]">
		<div class="container mx-auto px-5 pb-40 lg:pb-0 lg:px-10">
				...
				<div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
					...
					<div class="lg:col-span-8">
						<p class="text-white text-center lg:text-left text-sm lg:text-md w-full lg:w-3/4">
							We are number 1 Zoo Ticketing Agent in Bali. Trusted by more than 10.000 monthly
							visitors, we offer you the best deal for your Bali Zoo trip.
						</p>
					</div>
					<div class="lg:col-span-2">
			...
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
				<div class="lg:col-span-3 gap-4">
					<ul class="text-center lg:text-start">
						<li class="mb-2">
							<a data-sveltekit-reload  href="/" class="text-brown boldfont text-md lg:text-xl">Home</a>
						</li>
						<li class="mb-2">
							...
							<!-- <ul>
								...
								<li>
									<a data-sveltekit-reload  href={`/vendor/${vendor.slug}`} class="text-brown">{vendor.name}</a>
								</li>
								{/each}
							</ul> -->
						</li>
						<li class="mb-2">
							<a data-sveltekit-reload  href="/ticket" class="text-brown boldfont text-md lg:text-xl">Tickets</a>
						</li>
						<li class="mb-2">
							<a data-sveltekit-reload  href="/contact" class="text-brown boldfont text-md lg:text-xl">Contact Us</a>
						</li>
					</ul>
				</div>
				<div class="lg:col-span-4 gap-4">
					<h1 class="text-md lg:text-xl text-center lg:text-start boldfont text-brown">
						Our Office
					</h1>
					<div class="flex items-center justify-center lg:justify-start gap-4 my-4">
						<div>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
						...
						<div>
							<p class="text-sm text-center lg:text-start text-brown">
								Regus Benoa Square, Jl. Bypass Ngurah Rai No. 21A, Badung Regency, Bali
							</p>
						</div>
					</div>
					...
					<div class="flex items-center justify-center lg:justify-start gap-4 mb-4">
						...
						<div>
							<p class="text-sm text-center lg:text-start text-brown">(+62) 0888 8888 8888</p>
						</div>
					</div>
				</div>
				<div class="lg:col-span-4 gap-4">
			...
			<div class="mt-10 text-center text-brown">
				<hr class="bg-brown border-0 h-[1px]" />
				<p class="py-5">Copyright © MindiMedia 2024 | Powered by Escape Link & Guires Solutions</p>
			</div>
		</div>
	</footer>
</template>
