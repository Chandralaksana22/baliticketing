			...
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
				<div class="lg:col-span-3 gap-4">
					<ul class="text-center lg:text-start">
						<li class="mb-2">
							<a href="/" class="text-brown boldfont text-md lg:text-xl">Home</a>
						</li>
						<li class="mb-2">
							...
							<!-- <ul>
								...
								<li>
									<a href={`/vendor/${vendor.slug}`} class="text-brown">{vendor.name}</a>
								</li>
								{/each}
							</ul> -->
						</li>
						<li class="mb-2">
							<a href="/ticket" class="text-brown boldfont text-md lg:text-xl">Tickets</a>
						</li>
						<li class="mb-2">
							<a href="/contact" class="text-brown boldfont text-md lg:text-xl">Contact Us</a>
						</li>
					</ul>
				</div>
