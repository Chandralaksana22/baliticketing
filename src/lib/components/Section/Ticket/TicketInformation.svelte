	...
	<div class="border border-sky-500 rounded-xl">
	  <h2>
		<button
		  ...
		  on:click={() => toggleAccordion('accordion-collapse-body-1')}
		>
		  <span>Highlight</span>
		  <svg
			data-accordion-icon
	...
	<div class="border border-sky-500 rounded-xl mt-2">
	  <h2>
		<button
		  ...
		  on:click={() => toggleAccordion('accordion-collapse-body-2')}
		>
		  <span>Inclusion</span>
		  <svg
			data-accordion-icon
	...
	<div class="border border-sky-500 rounded-xl mt-2">
	  <h2>
		<button
		  ...
		  on:click={() => toggleAccordion('accordion-collapse-body-3')}
		>
	...
	<div class="border border-sky-500 rounded-xl mt-2">
	  <h2>
		<button
		  ...
		  on:click={() => toggleAccordion('accordion-collapse-body-4')}
		>
		  <span>Location</span>
		  <svg
			data-accordion-icon
